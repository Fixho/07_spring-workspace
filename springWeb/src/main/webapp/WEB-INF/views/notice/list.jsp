...
<style>
        #noticeList th, #noticeList td:not(:nth-child(2)){text-align: center;}
                ...
                <tbody>
                	<c:choose>
                     ...
                     <c:otherwise>
                       ...
                       <tr onclick='location.href="${contextPath}/notice/${ loginUser.userId eq n.noticeWriter ? "detail.do" : "increase.do" }?no=${ n.noticeNo }";'>
                        <td>${ n.noticeNo }</td>
                        <td>${ n.noticeTitle }</td>
