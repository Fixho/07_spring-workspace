...
<body>
	...
	<h2>2. 다중 첨부파일 업로드 테스트</h2>
	 <form action="${ contextPath }/board/insert2.do" method="post" enctype="multipart/form-data">
		...
		<label>가 첨부파일 사이즈는 10MB 이하, 총 100MB 이하여야 됩니다.</label> <br><br>
		...
		$(function(){
			...
			$("#submit").on("click", function(){
				...
				$.ajax({
					...
					contentType: false, // contentType : false 선언시 multipart/form-data로 전송 되게 함
					  ...
					  for(let i=0; i<images.length; i++){
						  ...
						  $.ajax({
							  ...
							  success: function(src){
								  // 파일 업로드 후에 저장경로 + 저장파일명을 응답 데이터로 받아
