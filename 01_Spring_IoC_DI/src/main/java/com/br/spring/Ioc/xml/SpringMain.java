...
public class SpringMain {
	...
	public static void main(String[] args) {
		...
		// * Spring 사용전 (개발자가 필요한 객체를 직접 생성해서 사용)
	    //Calculator calc = new Calculator();	
		
		// * Spring 사용 후 (프레임워크가 미리 생성해둔 반을 가져다 씀)
		 ...
		 *   직접 Dao 객체를 new 생성해서 호출함 
		 
		 *   => 매 요청마다 새로운 dao 객체 생성되고 소멸됨(매번 주소값 변경)
		 *   	=> 메모리 사용이 빈번함
		 *   
