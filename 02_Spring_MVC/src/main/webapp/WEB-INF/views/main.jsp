...
<body>
	<!-- /또는 /main.do 라는 url mapping으로 요청시 해당 /WEB-INF/views/main.jsp가 보여지도록 -->
	<h1>메인페이지 입니다</h1>
	
	<h3>1. 정적인 자원 확인</h3>
	<img src="${ contextPath }/resources/images/pizza.jpg.png" width="150" onclick="test();">
	<img src="${ contextPath }/assets/images/flower5.jpg" width="100" id="img">
