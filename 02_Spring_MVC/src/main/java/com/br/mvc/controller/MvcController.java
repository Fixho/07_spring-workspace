 ...
 * 		 스프링이 해당 객체를 관리할 수 있도록 Bean으로 등록되어야됨
...
public class MvcController {
	 ...
	 * 
	 * public void doGet(HttpServeletRequest request, HttpServletResponse response) throws Exception {
	 * 		// 1) 포워딩 할 경우
	 ...
	 * 2. 해당 클래스 내에 url요청별로 실행시킬 메소드 작성 후 @RequestMapping으로 url
	 * 
	 ...
	 * 
	 * 	<속성>
	 * 	1) value 속성 : URL Mapping 값, 여러개 작성 가능, 속성명 생략시 수정
	 ...
	 *       ㄴ RedirectAttributes arr : redirect 할때 필요한 데이터(flash attribute)를 담는 개체
	 * 
	 */
	
	 @RequestMapping(value={"/", "/main.do"}, method=RequestMethod.GET) 
	 public String welcomePage() {
		 System.out.println("MvcController클래스의 welcomPage 메소드 작동됨");
		 return "main";
		 /*
